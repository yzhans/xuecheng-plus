...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\software\\plugin\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "D:\\software\\plugin\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\xoo\\AppData\\Local\\Temp\\minio9061967270328272566.merge";
        //转换后mp4文件的名称
        String mp4_name = "8000015dd9176f24352d22b03bf0f846.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\download\\331.mp4";
        //创建工具类对象
