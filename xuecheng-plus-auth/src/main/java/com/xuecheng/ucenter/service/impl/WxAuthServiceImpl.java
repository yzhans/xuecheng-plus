...
public class WxAuthServiceImpl implements AuthService, WxAuthService {
    ...
    private Map<String, String> getAccess_token(String code) {
        String url_obj = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=%s&secret=%s&code=%s&grant_type=authorization_code";
        //请求微信地址
        String wxUrl = String.format(url_obj, appid, secret, code);
    ...
    private Map<String, String> getUserinfo(String access_token, String openid) {
        String sourceURL = "https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s";
        String url = String.format(sourceURL, access_token, openid);
    ...
    /***
     * @description 将微信用户信息存入数据库
     * @param userInfo_map 微信信息
     * @return com.xuecheng.ucenter.model.po.XcUser
     * @author xoo
     * @date 2023/9/24 12:43
     */
    @Transactional
    public XcUser addWxUser(Map<String, String> userInfo_map) {
        ...
        System.err.println(xcUserRole.getCreateTime());
